...
const projetos: Projeto[] = [
  {
    ...
    categoria: 'Cultura',
    descricao:
      'Produção de três espetáculos teatrais protagonizados por atores surdos, com circulação em equipamentos culturais da cidade de São Paulo e região metropolitana.',
    ano: '2023',
  },
  {
    ...
    categoria: 'Educação',
    descricao:
      'Oferta de cursos profissionalizantes em tecnologia da informação, design gráfico e artesanato para jovens e adultos surdos residentes na Grande São Paulo.',
    ano: '2024',
  },
  {
    ...
    descricao:
      'Produção e distribuição de conteúdo em Libras sobre eventos culturais e artísticos do estado, promovendo a inclusão e o acesso à cultura para a comunidade surda.',
    ano: '2024',
  },
]
    ...
    <main>
      ...
      <div className="max-w-4xl mx-auto px-4 py-14">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <h2 className="text-lg font-extrabold text-[#1B3A6B] leading-snug">
                        {projeto.titulo}
                      </h2>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed pl-11 mb-4">
                    {projeto.descricao}
                  </p>
        ...
        <p className="text-xs text-gray-400 mt-8 text-center">
          Para mais informações sobre os projetos aprovados, consulte os relatórios anuais ou entre em contato com a diretoria.
        </p>
